...
/* DEFAULT */
    LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LGUI,          KC_LALT,                   KC_SPC,                             KC_RALT, MO(_FN1),         TO(_FN2),KC_RCTL),

/* HYPER */
    LAYOUT_60_ansi(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,           KC_DEL,
        __TRN__,          __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, __TRN__, KC_NUHS,
...
/* _FN2 */
    LAYOUT_60_ansi(
        ...
        KC_BTN1, KC_BTN2,          KC_BTN3,                   __TRN__,                            __TRN__, __TRN__,          TO(_DEFAULT), __TRN__)
