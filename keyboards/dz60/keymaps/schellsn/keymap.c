...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_DEFAULT] = LAYOUT_2_shifts(
            ...
            KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC, MO(2), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
	...
	[_LAYER_SELECT] = LAYOUT_2_shifts(
            TO(0), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,
	...
	[_MEDIA] = LAYOUT_2_shifts(
            TO(0), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, KC_VOLD, KC_VOLU, ______, ______,
            ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,
            ...
            ______, ______, ______, ______, ______, ______, TO(0), KC_MPRV, KC_MSTP, KC_MPLY, KC_MNXT),

	[_BACKLIGHT] = LAYOUT_2_shifts(
            TO(0), ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, BL_DEC, BL_INC, BL_TOGG, BL_TOGG,
            ...
            RGB_TOG, RGB_MODE_FORWARD, RGB_MODE_REVERSE, ______, ______, ______, TO(0), RGB_HUD, RGB_VAD, RGB_VAI, RGB_HUI),

	[_MOUSE] = LAYOUT_2_shifts(
            TO(0), KC_MS_ACCEL0, KC_MS_ACCEL1, KC_MS_ACCEL2, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______,
            ...
            KC_MS_BTN1, KC_MS_BTN2, KC_MS_BTN3, ______, ______, ______, TO(0), KC_MS_LEFT, KC_MS_DOWN, KC_MS_UP, KC_MS_RIGHT)
};
